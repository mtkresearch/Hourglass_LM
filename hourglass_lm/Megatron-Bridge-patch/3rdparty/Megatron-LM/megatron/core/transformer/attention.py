...
class SelfAttention(Attention):
    ...
    def __init__(
        ...
        if submodules.q_layernorm is not None:
            self.q_layernorm = build_module(
                ...
                hidden_size=self.num_attention_heads_per_partition
        ...
        if submodules.k_layernorm is not None:
            self.k_layernorm = build_module(
                ...
                hidden_size=self.num_query_groups_per_partition
                * self.hidden_size_per_attention_head,
                config=self.config,
                eps=self.config.layernorm_epsilon,
            )
    ...
    def get_query_key_value_tensors(
        ...
        # Apply Q/K norm before converting query to per-head layout.
        # This keeps the normalization path on packed Q/K representations.
        # HOURGLASS
