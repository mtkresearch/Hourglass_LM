...
class WandBLogger():
    ...
    The project name is read from cfg.logger.project. To run without a wandb
    account, set the environment variable WANDB_MODE=offline (or disabled).
    """
    def __init__(self, cfg):
        self.cfg = cfg
        exp_name = cfg.logger.get('exp_name', None)
        self.logger = wandb.init(
            project=cfg.logger.get('project', 'hourglass-vit'),
            name=exp_name,
